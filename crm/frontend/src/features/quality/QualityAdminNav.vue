 ...
 */
import { DataBoard, CircleCheck, Cpu, DataAnalysis, TrendCharts, Document, Refresh, Histogram } from '@element-plus/icons-vue'
...
const entries: Array<{ key: QualityModule; label: string; hint: string; icon: typeof DataBoard }> = [
  ...
  { key: 'logs', label: '日志中心', hint: '运行、SQL 复核与会话日志', icon: Document },
