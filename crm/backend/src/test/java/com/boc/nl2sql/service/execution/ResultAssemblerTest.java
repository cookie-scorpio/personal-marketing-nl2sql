...
class ResultAssemblerTest {
    @Test void exposesTotalAndPaginationInsteadOfSilentTruncation(){
        ...
        var page=new com.boc.nl2sql.domain.execution.PagedQueryRows(rows,205,
                new com.boc.nl2sql.domain.execution.QueryPage(1,100,0));
    ...
    private com.boc.nl2sql.domain.execution.QueryResult assemble(String type, List<Map<String, Object>> rows) {
