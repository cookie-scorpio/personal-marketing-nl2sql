...
import com.boc.nl2sql.service.conversation.*;
import com.boc.nl2sql.dao.conversation.*;
import com.boc.nl2sql.dao.execution.*;
import com.boc.nl2sql.service.execution.*;
import com.boc.nl2sql.domain.execution.*;
import com.boc.nl2sql.model.*;
import com.boc.nl2sql.service.nl2sql.*;
...
class QueryTaskProcessorTest {
    ...
    void setup() {
        ...
        processor = new QueryTaskProcessor(mapper, states, model, new CompletenessValidator(), planner,
                ...
                new com.boc.nl2sql.service.nl2sql.DisplayConflictGuard(), 2);
